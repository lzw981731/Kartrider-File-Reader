...
namespace KartLibrary.Game.Engine.Tontrollers
{
     ...
     */
    // Type 0 Keyframe
    public class FloatKeyDataFactory
    {
        public IFloatKeyData CreateFloatKeyframeData(FloatKeyDataType keyDataType)
        {
            switch (keyDataType)
            {
                case FloatKeyDataType.Cubic:
                    return new CubicFloatKeyData();
                case FloatKeyDataType.Linear:
                    return new LinearFloatKeyData();
                case FloatKeyDataType.CubicAlt:
                    return new CubicAltFloatKeyData();
                case FloatKeyDataType.NoEasing:
                    return new NoEasingFloatKeyData();
                default:
    ...
    public interface IFloatKeyData : IKeyData<float>
    {
        FloatKeyDataType KeyDataType { get; }
    }

    public abstract class FloatKeyData<TKeyframe> : IFloatKeyData, IList<TKeyframe> where TKeyframe : IKeyframe<float>
    {
        protected FloatKeyData()
        {
        ...
        public abstract FloatKeyDataType KeyDataType { get; }
    ...
    public class LinearFloatKeyData : FloatKeyData<LinearFloatKeyframe>
    {
        public override FloatKeyDataType KeyDataType => FloatKeyDataType.Linear;
    ...
    public class CubicFloatKeyData : FloatKeyData<CubicFloatKeyframe>
    {
        public override FloatKeyDataType KeyDataType => FloatKeyDataType.Cubic;
    ...
    public class CubicAltFloatKeyData : FloatKeyData<CubicAltFloatKeyframe>
    {
        public override FloatKeyDataType KeyDataType => FloatKeyDataType.CubicAlt;
    ...
    public class NoEasingFloatKeyData : FloatKeyData<NoEasingFloatKeyframe>
    {
        public override FloatKeyDataType KeyDataType => FloatKeyDataType.NoEasing;
    ...
    public class CubicAltFloatKeyframe : IKeyframe<float>
    {
        ...
        public float CalculateKeyFrame(float t, IKeyframe<float>? nextKeyframe)
        {
            ...
            if (nextKeyframe is null)
                return Value;
            if (nextKeyframe is not CubicAltFloatKeyframe)
                throw new ArgumentException();
            CubicAltFloatKeyframe next = (CubicAltFloatKeyframe)nextKeyframe;
            float delta = next.Value - Value;
            float a = RightSlop + next.LeftSlop - 2 * delta;
            float b = 3 * delta - next.LeftSlop - 2 * RightSlop;
            float c = RightSlop;
